...
def run():
	...
	window = sdl2.ext.Window("Hello LinuxPratique!", size=(480, 320))
	...
	spriteArray = ["LP_480x320.jpg", "lmag_480x320.jpg", "hackable_480x320.jpg"]
	...
	#sprite = factory.from_image(RESOURCES.get_path("LP_480x320.jpg"))
	#sprite = factory.from_image(RESOURCES.get_path(spriteArray[0]))
	...
	running = True
	while running:
		sprite = factory.from_image(RESOURCES.get_path(spriteArray[num]))	
		spriterenderer.render(sprite)
		window.refresh()
		timer.SDL_Delay(2000)
		if num >=2:
			num = 0
		else:
			num=num+1
